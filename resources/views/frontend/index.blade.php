                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="main_slider" data-slick='{"arrows": false}'>
                            ...
                            <div class="slider_item set-bg-image" data-background="{{ asset('uploads/slider_photos')}}/{{$slider->slider_photo}}">
                                <div class="slider_content">
                                    <h3 class="small_title" data-animation="fadeInUp2" data-delay=".2s">{{$slider->small_tittle}}</h3>
                                    <h4 class="big_title" data-animation="fadeInUp2" data-delay=".4s">{{$slider->big_tittle}}  <span>{{$slider->big_sub_tittle}}</span></h4>
                                    <p data-animation="fadeInUp2" data-delay=".6s">{{$slider->slider_discription}}</p>
                                    <div class="item_price" data-animation="fadeInUp2" data-delay=".6s">
                                        <del>${{$slider->del_price}}</del>
                                        <span class="sale_price">${{$slider->sell_price}}</span>
                                    </div>
                                            ...
                                            <div class="category_boxed">
                                                <a href="#!">
                                                    <span class="item_image">
                                                        <img src="{{ asset('uploads/category_photos')}}/{{$top_category->category_photo}}" class="img-fluid" alt="Not found">
                                                    </span>
